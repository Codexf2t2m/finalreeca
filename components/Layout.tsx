...
import { Home, Users, Bus, FileText, LogOut, Bell, Calendar } from "lucide-react";
            ...
            <ul className="space-y-1">
              {navItems.map((item) => (
                <li key={item.href}>
                  <Link href={item.href}>
                    <div
                      className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer ${activeTab === item.href ? "bg-teal-50 text-teal-600" : "hover:bg-gray-100"}`}
