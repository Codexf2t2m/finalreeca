...
interface BookingData {
  ...
  country: string;
  address: string;
  havePrivilegeCard: boolean;
  haveCashCoupon: boolean;
  paymentMode: string;
  returnTripId?: string;
    ...
    const initiatePayment = async () => {
      try {
        ...
        const requestData = {
          ...
          redirectUrl: `${window.location.origin}/payment/success?ref=${bookingData.orderId}`,
          backUrl: `${window.location.origin}/payment/cancel?ref=${bookingData.orderId}`,
