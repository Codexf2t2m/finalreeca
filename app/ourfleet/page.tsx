        ...
        <div className="container mx-auto px-3 sm:px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="sm:col-span-2 lg:col-span-1">
              <h3 className="text-base sm:text-lg font-bold mb-3 sm:mb-4">REECA TRANSPORT</h3>
            ...
            <div>
              ...
              <ul className="space-y-1.5 sm:space-y-2">
                ...
                <li><a href="/booking" className="text-gray-400 hover:text-white text-sm sm:text-base">Book a Trip</a></li>
                <li><a href="/ourfleet" className="text-gray-400 hover:text-white text-sm sm:text-base">Our Fleet</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white text-sm sm:text-base">Contact Us</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold mb-3 sm:mb-4 text-sm sm:text-base">Information</h4>
              <ul className="space-y-1.5 sm:space-y-2">
                <li><a href="https://reecatravel.co.bw/forum/termandcondition" className="text-gray-400 hover:text-white text-sm sm:text-base">Terms & Conditions</a></li>
                <li><a href="https://reecatravel.co.bw/forum/privacypolicy" className="text-gray-400 hover:text-white text-sm sm:text-base">Privacy Policy</a></li>
                <li><a href="https://reecatravel.co.bw/forum/cancellationpolicy" className="text-gray-400 hover:text-white text-sm sm:text-base">Cancellation Policy</a></li>
              </ul>
            </div>
            <div className="sm:col-span-2 lg:col-span-1">
              <h4 className="font-bold mb-3 sm:mb-4 text-sm sm:text-base">Contact</h4>
              <address className="not-italic text-gray-400 text-sm sm:text-base leading-relaxed">
                <p className="mb-1">Mogobe Plaza, Gaborone CBD, 4th Floor</p>
                <p className="mb-1">Emergency Phone: +267 77655348</p>
                <p className="mb-1">Office Line: +267 73061124</p>
                <p className="mb-1">WhatsApp: +267 76506348</p>
                <p className="mb-1">Email: tickets@reecatravel.co.bw</p>
                <p>Travel Services: traveltalk@reecatravel.co.bw</p>
              </address>
            </div>
          </div>
          <div className="mt-6 sm:mt-8 text-center text-gray-500">
            <p className="text-xs sm:text-sm">© {new Date().getFullYear()} REECA Transport. All rights reserved.</p>
          </div>
        </div>
      </footer>
      {showHireModal && (
